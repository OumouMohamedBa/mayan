  ...
  return (
    <div className="min-h-screen min-h-[100dvh] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <Image
          src="https://images.unsplash.com/photo-1568667256549-094345857637?q=80&w=1915&auto=format&fit=crop"
          alt="Gestion de documents"
          fill
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12">
          <div className="max-w-md text-center">
            ...
            <p className="text-lg text-white/80 leading-relaxed">
              Gérez vos documents en toute simplicité. Stockez, organisez et retrouvez vos fichiers en quelques clics.
            </p>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="block w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50 focus:bg-white"
